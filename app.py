...
from scoring_engine import run_scoring, score_stock
...
from llm_harness import has_active_api_key, generate_ai_narrative, discuss_with_jarvis
...
if st.session_state["stock_cache"]:
    ...
    if selected_cap != "All Stocks":
        df = df[df["Category"] == selected_cap]
        latest_highs = latest_highs[latest_highs["Category"] == selected_cap]
        continuous = continuous[continuous["Category"] == selected_cap]
        red_alerts = red_alerts[red_alerts["Category"] == selected_cap]
        
    df = df[df["Total Score"] >= min_score]
        ...
        if not has_active_api_key():
            ...
            if user_input:
                ...
                with st.spinner("Jarvis is thinking..."):
                    ...
                    jarvis_reply = discuss_with_jarvis(user_input, chat_hist_tuples, df)
