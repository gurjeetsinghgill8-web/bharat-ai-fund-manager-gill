...
FALLBACK_TICKERS = [
    ...
    "HAL", "GMRINFRA", "COFORGE", "PERSISTENT", "DIXON", "ASTRAL", "AUROPHARMA",
    ...
    "AMBUJACEM", "ACC", "ICICIPRULI", "HDFCLIFE", "DALBHARAT", "SRTRANSFIN",
    "TVSMOTOR", "MUTHOOTFIN", "BIOCON", "LUPIN", "TORNTPHARM", "ALKEM",
    "CADILAHC", "ABB", "BOSCHLTD", "PIDILITIND", "WHIRLPOOL", "BLUESTARCO",
    "AARTIIND", "NAVINFLUOR", "DEEPAKNTR", "SRF", "CROMPTON", "VOLTAS",
    "AMBER", "VBL", "ZOMATO", "PAYTM", "NYSE:INDIAN", "POLICYBZR",
]
